...
5.  **Max Build RAM:** Native image derleme süreci çok fazla RAM tüketir. Sisteminizin belleğine uygun olan en yüksek miktarı seçmeniz derleme süresini kısaltacaktır.
6.  **Build Native Image** butonuna tıklayın. İşlem başlayacak ve derleme detayları anlık olarak alt kısımdaki *Build Console* ekranına yansıyacaktır. İşlem bitiminde hedef JAR dosyanızın bulunduğu dizinde .exe dosyanız hazır olacaktır.
